...
return new class extends Migration {
    ...
    public function up()
    {
        Schema::table('task_status_logs', function (Blueprint $table) {
            DB::statement("ALTER TABLE `task_status_logs` CHANGE `previousStatus` `previousStatus` enum('0','1','2','3','4','5','6','7','8')
            ...
            ");
            DB::statement("ALTER TABLE `task_status_logs` CHANGE `currentStatus` `currentStatus` enum('0','1','2','3','4','5','6','7','8')
            COLLATE 'utf8mb4_unicode_ci' NOT NULL DEFAULT '7'
            COMMENT '0:assigned, 1:In Progress, 2:Assigned for review, 3:reviewing, 4:reviewed, 5:Completed, 6:Closed, 7:created, 8: uploaded to production'
            ");
        });
